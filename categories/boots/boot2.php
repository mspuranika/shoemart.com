        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/boots/boot2.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        ...
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            The brand is enough to impress you. You cannot get a better deal for this Woodland
                            boot anywhere else, we assure you that. It is one of the very rare products from
                            Woodland which comes with a warranty.
                        </p><br>
