        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/boots/boot5.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.1470.00</li><br><br>
                        <li>woodland</li><br><br>
                        <li>1 Years</li><br><br>
                    </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                                This is an ultimate fashion statement from woodland only for stylish
                                women! Excellent deal for 1450! And also, warranty upto an year.
                        </p><br>
