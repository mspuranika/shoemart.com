        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/loafers/loafer9.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.2000.00</li><br><br>
                        <li>Levi's</li><br><br>
                        <li>2 Years</li><br><br>
                        <li>20%</li><br><br>
                        <li><b><u>Rs.1600.00</u></b></li>
                   </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                          Levi's has a very less number of loafer in its range, it is crafted from complete leather
                          and an astonishing warranty for two years! And 20% discount from our side which you can get nowhere else!
                        </p><br>
