        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/canvas/canvas7.jpg" alt="canvas7" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        ...
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            This is perfect for the classy looking Men! Armani gives you an awesome two years warranty on it.
                            Material used for making is quite rough so gives an elegant look.
                        </p><br>
