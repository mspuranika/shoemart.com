        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/canvas/canvas9.jpg" alt="canvas9" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.312.00</li><br><br>
                        <li>Show Off</li><br><br>
                        <li>No Warranty</li><br><br>
                   </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            Searching for a multi patterned sneaker which suits for a tee? Here you go!
                            So affordable canvas shoe form ShowOff! You can really show-off wearing it.
                        </p><br>
