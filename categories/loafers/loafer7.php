        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/loafers/loafer7.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        ...
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            Here comes the cheapest loafer from YepMe, believe it or not, just for 350 rupees! it's 
                            blue color gives a funky look and its the most affordable product in our category.
                        </p><br>
