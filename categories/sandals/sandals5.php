        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/sandals/sandals5.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.200.00</li><br><br>
                        <li>Hype</li><br><br>
                        <li>No Warranty</li><br><br>
                  </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                          A kind of fashionable slipper from Hype, so bright red in color, just for rupees
                          200. Looks good with dark colored jeans.
                        </p><br>
