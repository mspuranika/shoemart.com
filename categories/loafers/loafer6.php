        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/loafers/loafer6.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.1000.00</li><br><br>
                        <li>NewPort</li><br><br>
                        <li>1 Year</li><br><br>
                        <li>50%</li><br><br>
                        <li><b><u>Rs.500.00</u></b></li>
                    </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                               Want to go for a leathered loafer? NewPort gives you its best product, that too,
                            with flat 50% discount! It has also got a warranty period for one year.
                        </p><br>
