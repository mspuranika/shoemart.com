        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/loafers/loafer1.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.499.00</li><br><br>
                        <li>HiFi</li><br><br>
                        <li>No Warranty</li><br><br>
                    </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            Cool colored loafer from HiFi. Though it has not got any warranty, we assure you
                            it is durable. Looks good on any colored cotton jeans. Price is affordable.
                        </p><br>
