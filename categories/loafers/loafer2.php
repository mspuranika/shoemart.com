        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    ...
                    <ul style="float:left;">
                        <li>Rs.390.00</li><br><br>
                        <li>Khadims</li><br><br>
                        <li>No Warranty</li><br><br>
                    </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            Khadim's got a very less number of loafers and this is one among them, it's glossy look
                            makes it a perfect shoe to wear it on a party or in any occasion. Price is just 390.
                        </p><br>
