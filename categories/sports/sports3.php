        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/sports/sports3.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.750.00</li><br><br>
                        <li>Sparx</li><br><br>
                        <li>6 Months</li>
                    </ul><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            Sparx gives you most affordable sports shoes in our collection, belive it or not,
                            it is just 750 bucks! And also it has got the warranty upto 6 months. It is a very good running
                            shoe.
                        </p><br>
