        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/sports/sports5.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        ...
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                           Khadims has a very less number of sports shoes that are designed for women, above is one
                           among them. It is very light weight, gives you a feeling that you're running on a bear foot!!
                           Price is just 670.
                        </p><br>
