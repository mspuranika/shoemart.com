        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/sports/sports2.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.1750.00</li><br><br>
                        <li>Reebok</li><br><br>
                        <li>1 Year</li><br><br>
                   </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            When it comes to Sports shoes, Reebok never compromises with the quality, its thick
                            material and strong sole lasts longer than any other shoes in its range, price is just 1750.
                        </p><br>
