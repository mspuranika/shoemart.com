        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/office/office5.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.599.00</li><br><br>
                        <li>John Players</li><br><br>
                        <li>6 Months</li><br><br>
                    </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            Searching for low heeled formal shoe for women? Here is the best possible choice.
                            John Players gives you the product with a warranty upto 6 months, and it costs just 600 bucks.
                        </p><br>
