        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/sandals/sandals3.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        ...
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                           A great flip flop from Puma, which is very high demand.  The black and blue color matches
                           perfectly, and has a very hard sole which makes it durable, warranty upto one year.
                        </p><br>
