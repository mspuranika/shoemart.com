        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/sandals/sandals6.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.250.00</li><br><br>
                        <li>Cat Walk</li><br><br>
                        <li>2 Months</li><br><br>
                        <li>30%</li><br><br>
                        <li><b><u>Rs.175.00</u></b></li>
                    </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                           This is a very good party wear from CatWalk, just for rupees 250. And believe it or not,
                           we give you 30% discount over it.
                        </p><br>
