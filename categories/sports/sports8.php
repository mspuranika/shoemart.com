        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/sports/sports8.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.4990.00</li><br><br>
                        <li>Nike</li><br><br>
                        <li>3 Years</li><br><br>
                        <li>10%</li><br><br>
                        <li><b><u>Rs.4499.00</u></b></li>
                    </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            One of the costliest sport shoes in this category, and the best product too! Its light weight and 
                            sweat absorbant material gives you immense pleasure in wearing it, best suitable for running and jogging
                            . We give you 10% discount on it.
                        </p><br>
