        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/sandals/sandals7.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        ...
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                            Clarks giving you the best party wear from its collections, very high heeled, perfect for
                            short women, looks good on any colored gowns and short skirts too. One year warranty is 
                            available.
                        </p><br>
