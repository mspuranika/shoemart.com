        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C cellpadding="10px"style="border:groove;border-color:#202122;">
                <td align="center" height="100%" width="100%">
                    <img src="../../images/sandals/sandals4.jpg" alt="canvas1" style="float:left;"/>
                    ...
                    <ul style="float:left;">
                        <li>Rs.1999.00</li><br><br>
                        <li>Woodland</li><br><br>
                        <li>1 Year</li><br><br>
                         <li>15%</li><br><br>
                        <li><b><u>Rs.1700.00</u></b></li>
                   </ul><br><br><br><br><br><br><br><br><br>
                        <p style="width:550px;float:left;margin-left:30px;"class="verydetail">
                         Woodland maintains its own class in their range of sandals, this is one among them!
                         It has come up with world class comfort and the thickest soul, we give you 15% discount.
                        </p><br>
