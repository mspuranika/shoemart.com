    ...
    <body>
        ...
        <div class="scrollable">
            ...
            <table width="100%" height="100%" bgcolor=#47525C  cellpadding="10px" style="border:groove;border-color:#202122;">
                <tr>  <td align="center" height="100%" width="100%">
                        <img src="../../images/canvas/canvas1.jpg" alt="canvas1" style="float:left;"/>
                        <p class="productdetail">Product Details:</p><hr>
                        <ul style="float:left;color:white;margin-left: 130px;height:50px;">
                            <li>Price:</li><br><br>
                            <li>Make:</li><br><br>
                            <li>Warranty:</li><br><br>
                        </ul>
                        <ul style="float:left;margin-left: 75px;height:50px;">
                            <li>Rs.450.00</li><br><br>
                            <li>Ruggers</li><br><br>
                            <li>1 Year</li><br><br>
                        </ul><br><br><br><br><br><br><br><br><br><hr>
